...
NOTE: Se están desarrollando paquetes para Red Hat 8, CentOS 8 Stream, Rocky Linux 8 o similares. Por favor, consulte https://github.com/gbif/ipt/issues/1646[este issue] si puede ayudar con las pruebas, o utilice Red Hat 7 / CentOS 7 en su lugar.
...
Los contenedores de servlets más utilizados para desplegar el IPT son Tomcat, Jetty y Wildfly. El contenedor de servlets debe ser compatible con Servlet Specification 3.0, 3.1 o 4.0.

=== Tomcat

El IPT ha sido probado y funciona bien con versiones recientes de Tomcat 8.5 o 9. La documentación de Apache Tomcat puede consultarse en https://tomcat.apache.org/.
...
_Como una guía muy aproximada, en CentOS 7, se puede ejecutar una sola instancia del IPT:_.
