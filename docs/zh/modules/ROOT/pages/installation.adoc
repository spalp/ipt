...
NOTE: Packages for Red Hat 8, CentOS 8 Stream, Rocky Linux 8 or similar are being developed. Please see https://github.com/gbif/ipt/issues/1646[this issue] if you can help with testing, or use Red Hat 7 / CentOS 7 instead.
